          ...
          id("number-container").children[i].addEventListener("click",function() {
              ...
              if(!disableSelect) {
                  ...
                  if(this.classList.contains("selected")) {
                      ...
                      //Select it and update selectedNum cariable
...
//Converts seconds into string of minute:seconds format
  ...
  function generateBoard(board) {
      ...
      for(let i = 0; i < 81; i++){
          ...
          if(board.charAt(i) != "-"){
              ...
              //Add clickevent listener to tile
          ...
          //Assign tile id
          tile.id = idCount;
          //Increment it for the next tile
          idCount++;
  ...
  function updateMove() {
      ...
      if(selectedTile && selectedNum) {
          ...
          if(checkCorrect(selectedTile)) {
              ...
              //If the selected number does not match with solution key
          } else {
              //disable selecting new numbers for a second
              disableSelect = true;
              ...
              setTimeout(function() {
                  ...
                  selectedTile.classList.remove("incorrect");
                  selectedTile.classList.remove("remove");
                  selectedNum.classList.remove("selected");
